             ...
             <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                     <?php if (empty($keranjang)) { ?>
                                 ...
                                 <div class="media">
                                     ...
                                     <div class="media-body">
                                         ...
                                         <p class="text-sm text-muted">
                                             <i class="far fa-calculator"></i>Rp. <?= $this->cart->format_number($value['subtotal']) ?>
                                         </p>
                                     </div>
                                 </div>
                             </a>
                         ...
                         <div class="dropdown-divider"></div>
                         <a href="<?= base_url('belanja') ?>" class="dropdown-item dropdown-footer">Lihat Keranjang Belanja</a>
                         <!-- <a href="#" class="dropdown-item dropdown-footer">Check Out</a> -->
                     <?php } ?>

                     <!-- keranjang atas kanan End -->
                 </div>
             </li>
             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">Konkrite Market</a></li>
